...
SELECT pg_catalog.setval('public.economic_mode_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.expected_outage_id_seq', 1, false);
...
SELECT pg_catalog.setval('public."radience_dynamic_nodesGIS_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public.radience_dynamic_nodes_links_id_seq', 1, false);
...
SELECT pg_catalog.setval('public."radience_static_nodesGIS_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public.radience_static_nodes_links_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.resiliency_scores_id_seq', 7323, true);
...
SELECT pg_catalog.setval('public.resilient_mode_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.threat_impacts_id_seq', 1, false);
